 ...
 * @author myGrid
 */
public class TavernaNodePlugin extends Plugin {
    // The shared instance.
    private static TavernaNodePlugin plugin;

    /**
     * The constructor.
     */
    public TavernaNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static TavernaNodePlugin getDefault() {
        return plugin;
    }
